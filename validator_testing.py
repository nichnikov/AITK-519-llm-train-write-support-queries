...
if __name__ == "__main__":
    ...
    t5_model = T5ForConditionalGeneration.from_pretrained(os.path.join("t5_validators", 't5_validator_40000_examples')).to("cuda")
    ...
    for fn in val_file_names[:5]:
        ...
        for num, text in enumerate(texts_list[:200]):
            print(num)
            try:
    ...
    print(results_df)
    results_df.to_csv(os.path.join(os.getcwd(), "test_results", "val_results_WrSupp_" + str(fn) + "_3f" + ".csv"), index=False)
